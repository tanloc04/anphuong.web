  ...
  if (!user)
    return (
      <div className="min-h-screen flex items-center justify-center">
        <i className="pi pi-spin pi-spinner text-4xl text-[#c4a484]"></i>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="relative h-60 bg-gray-800">
        ...
        <div className="container max-w-6xl mx-auto px-4 h-full flex items-end pb-8 relative z-10">
          <h1 className="text-3xl font-bold text-white tracking-wide ml-4 md:ml-0">
            Thiết lập tài khoản
          </h1>
        </div>
      </div>
              ...
              <div className="px-6 pb-6 -mt-12 flex flex-col items-center text-center">
                <div className="relative mb-3">
                  ...
                  <div className="absolute bottom-0 right-0 bg-white rounded-full p-1 shadow-sm border border-gray-100 cursor-pointer hover:bg-gray-50">
                    <FontAwesomeIcon
                      icon={faCamera}
                      className="text-gray-500 text-xs w-4 h-4"
                    />
                  </div>
                </div>

                <h2 className="text-xl font-bold text-gray-800">
                  {customerDetail?.fullname || user.fullname}
                </h2>
                ...
                <div className="w-full text-left space-y-3 mt-2">
                  ...
                  <div className="flex items-center gap-3 text-sm text-gray-600">
                    ...
                    <span
                      className="truncate"
                      title={customerDetail?.customerAddress}
                    >
          ...
          <div className="flex-1">
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 min-h-[400px]">
              <div className="flex border-b border-gray-100">
                ...
                >
                  <FontAwesomeIcon icon={faUser} className="mr-2" /> Thông tin
                  chung
                </button>
                <button
                ...
                >
                  <FontAwesomeIcon icon={faLock} className="mr-2" /> Đổi mật
                  khẩu
                </button>
              </div>
              ...
              <div className="p-6 md:p-8">
                  ...
                  >
                      ...
                      <div className="col-span-1 md:col-span-2">
                        ...
                        <div className="p-inputgroup">
                          ...
                          <InputText
                            value={user.email}
                            disabled
                            className="bg-gray-50 text-gray-500 w-full p-inputtext-sm"
                          />
                        </div>
                      </div>
                    ...
                    <div className="pt-4 text-right">
                      <Button
                        ...
                        icon="pi pi-save"
                        loading={loading}
                        className="bg-[#c4a484] border-none px-6 py-2 text-sm"
                      />
                    </div>
                  </form>
                )}
                ...
                {activeTab === "security" && (
                  <form
                    onSubmit={handleSubmitPass(onChangePass)}
                    className="max-w-md mx-auto space-y-4 animate-fade-in pt-2"
                  >
                    <div className="bg-yellow-50 p-3 rounded text-xs text-yellow-700 border border-yellow-200 mb-4 flex gap-2">
                      ...
                      <span>
                        Mật khẩu cần ít nhất 6 ký tự để đảm bảo an toàn.
                      </span>
                    </div>
