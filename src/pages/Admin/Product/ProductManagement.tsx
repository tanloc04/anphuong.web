    ...
    const actionBodyTemplate = (rowData: any) => {
        return (
            <div className="flex gap-2 justify-center">
                ...
                <Button icon="pi pi-sitemap" rounded text severity="help" tooltip="Quản lý biến thể" onClick={() => openVariationManager(rowData)} aria-label="Variants" disabled={rowData.isDeleted} />
